...
pub type Current = v0_4_0_beta_6::Version; // VERSION_BUMP
...
enum Version {
    ...
    V0_4_0_beta_6(Wrapper<v0_4_0_beta_6::Version>), // VERSION_BUMP
    Other(exver::Version),
}
...
impl Version {
    ...
    fn as_version_t(&self) -> Result<DynVersion, Error> {
        Ok(match self {
            ...
            Self::V0_4_0_beta_6(v) => DynVersion(Box::new(v.0)), // VERSION_BUMP
            Self::Other(v) => {
                return Err(Error::new(
    ...
    fn as_exver(&self) -> exver::Version {
        match self {
            ...
            Version::V0_4_0_beta_6(Wrapper(x)) => x.semver(), // VERSION_BUMP
