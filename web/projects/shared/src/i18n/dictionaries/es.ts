...
export default {
  ...
  587: 'No recomendado en la mayoría de los casos. El protocolo es inherentemente seguro, por lo que la dirección SSL solo es necesaria para aplicaciones que imponen SSL',
