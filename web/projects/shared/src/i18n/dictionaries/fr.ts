...
export default {
  ...
  587: 'Non recommandé dans la plupart des cas. Le protocole est intrinsèquement sécurisé, donc l’adresse SSL n’est nécessaire que pour les applications qui imposent SSL',
