...
export const ENGLISH: Record<string, number> = {
  ...
  'Network UPS Tools': 862,
  'Configure': 863,
  'Direct UPS': 864,
  'Client': 865,
  'Monitoring a directly connected UPS': 866,
  'Monitoring a network UPS server': 867,
  'Shut down safely when a UPS battery is low': 868,
  'NUT shuts down StartOS when the UPS battery is low.': 869,
  'Mode': 870,
  'UPS Name': 871,
  'Driver': 872,
  'Device or address': 873,
  'Monitor username': 874,
  'Monitor password': 875,
  'Allow network clients': 876,
  'Network client username': 877,
  'Network client password': 878,
  'Shutdown delay': 879,
  'Network UPS client': 880,
  'NUT server host': 881,
  'NUT server port': 882,
  'UPS Status': 883,
  'Configured target': 884,
  'No UPS data available': 885,
  'UPS status unavailable': 886,
  'StartOS could not read UPS status with the current NUT configuration.': 887,
  'The UPS did not return status data. Check the UPS name, host, port, credentials, and driver.': 888,
}
