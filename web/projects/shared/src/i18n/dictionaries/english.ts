export default {
  ...
  'Trust your Root CA': 479,
  'Download and trust your Root Certificate Authority to establish a secure (HTTPS) connection. You will need to repeat this on every device you use to connect to your server.': 480,
  'Bookmark this page': 481,
  'Save this page so you can access it later. You can also find this address in the file downloaded at the end of initial setup.': 482,
  'Download your Root CA': 483,
  'Your server uses its Root CA to generate SSL/TLS certificates for itself and installed services. These certificates are then used to encrypt network traffic with your client devices.': 484,
  'Follow instructions for your OS. By trusting your Root CA, your device can verify the authenticity of encrypted communications with your server.': 485,
  Test: 486,
  'Refresh the page. If refreshing the page does not work, you may need to quit and re-open your browser, then revisit this page.': 487,
  Skip: 488,
  'not recommended': 489,
  'Root CA Trusted!': 490,
  'You have successfully trusted your Root CA and may now log in securely.': 491,
  'Go to login': 492,
} as const
