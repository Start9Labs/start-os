        ...
        'network-interfaces': {
          ui: {
            ...
            addresses: {
              ...
              local: {
                name: 'Local',
                url: 'https://adjective-noun.local:1234',
              },
              'elan0-ipv4': {
                name: 'Ethernet (IPv4)',
          ...
          rpc: {
            ...
            addresses: {
              ...
              local: {
                name: 'Local',
                url: 'https://adjective-noun.local:2345',
              },
              'elan0-ipv4': {
                name: 'Ethernet (IPv4)',
          ...
          p2p: {
            ...
            addresses: {
              ...
              local: {
                name: 'Local',
                url: 'https://adjective-noun.local:3456',
              },
              'elan0-ipv4': {
                name: 'Ethernet (IPv4)',
        ...
        'network-interfaces': {
          rpc: {
            ...
            addresses: {
              ...
              local: {
                name: 'Local',
                url: 'https://adjective-noun.local:4567',
              },
              'elan0-ipv4': {
                name: 'Ethernet (IPv4)',
          ...
          p2p: {
            ...
            addresses: {
              ...
              local: {
                name: 'Local',
                url: 'https://adjective-noun.local:6789',
              },
              'elan0-ipv4': {
                name: 'Ethernet (IPv4)',
