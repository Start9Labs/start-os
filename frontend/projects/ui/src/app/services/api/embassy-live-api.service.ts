...
export class LiveApiService extends ApiService {
  ...
  async getMarketplaceData(
    ...
    return this.http.httpRequest({
      method: Method.GET,
      url: '/marketplace/package/v0/info',
      params,
    })
  }
  ...
  async getMarketplacePkgs(
    ...
    return this.http.httpRequest({
      method: Method.GET,
      url: '/marketplace/package/v0/index',
      params: {
        ...params,
  ...
  async getReleaseNotes(
    ...
    return this.http.httpRequest({
      method: Method.GET,
      url: `/marketplace/package/v0/release-notes/${params.id}`,
    })
  }
  ...
  async getLatestVersion(
    ...
    return this.http.httpRequest({
      method: Method.GET,
      url: '/marketplace/package/v0/latest',
      params,
    })
  }
