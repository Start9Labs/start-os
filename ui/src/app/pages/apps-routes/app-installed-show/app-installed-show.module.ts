...
import { AccordionInstructionsComponentModule } from '../../../components/accordion-instructions/accordion-instructions.component.module';
...
@NgModule({
  imports: [
    ...
    AccordionInstructionsComponentModule,
