...
export type Effects = {
  ...
  notification: {
     ...
     *
     * `code` selects the notification shape: `0` is a generic notification
     * (no `data`), `2` carries a free-form string `data` payload. Code `1`
     * is reserved for backup-report notifications generated by StartOS and
     * cannot be created by packages.
     */
