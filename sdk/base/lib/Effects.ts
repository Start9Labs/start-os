...
export type Effects = {
  ...
  notification: {
     ...
     *
     * `code` selects the notification shape: `0` is a plain notification
     * (no `data`); `2` carries a long-form, markdown-compatible `data`
     * body that the UI renders in a "View Details" modal (use this for
     * release notes, post-update changelogs, structured error reports,
     * etc.). Code `1` is reserved for backup-report notifications
     * generated by StartOS and cannot be created by packages.
     */
