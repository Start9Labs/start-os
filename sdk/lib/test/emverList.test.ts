  ...
  {
    {
      ...
      test("rangeOf('*')", () => {
        checker.check("1:0")
        checker.check("1.2:0")
        checker.check("1.2.3:0")
        checker.check("1.2.3:4")
        checker.check("1.2.3:4.5")
        checker.check("1.2.3:4.5.6")
        expect(checker.check("1:0")).toEqual(true)
        expect(checker.check("1.2:0")).toEqual(true)
...

    {
      ...
      test(`rangeOf(">1.2.3:4") valid`, () => {
        expect(checker.check("2-beta.123:0")).toEqual(true)
        expect(checker.check("2:0")).toEqual(true)
      ...
      test(`rangeOf(">1.2.3.4") invalid`, () => {
        ...
        expect(checker.check("1.2.3:0")).toEqual(false)
        expect(checker.check("1:0")).toEqual(false)
      })
    }
    {
      const checker = rangeOf("=1.2.3")
      test(`rangeOf("=1.2.3") valid`, () => {
        expect(checker.check("1.2.3:0")).toEqual(true)
      })

      test(`rangeOf("=1.2.3") invalid`, () => {
        expect(checker.check("2:0")).toEqual(false)
        expect(checker.check("1.2.3:1")).toEqual(false)
        expect(checker.check("1.2:0")).toEqual(false)
      })
    }
    {
      const checker = rangeOf(">=1.2.3.4")
...

    {
      ...
      test(`simple and(checkers) valid`, () => {
        ...
        expect(checker.check("1.1:0")).toEqual(true)
      })
      test(`simple and(checkers) invalid`, () => {
        expect(checker.check("2.1:0")).toEqual(false)
        expect(checker.check("1:0")).toEqual(false)
        expect(checker.check("1:0")).toEqual(false)
      })
    }
    {
      ...
      test(`simple or(checkers) valid`, () => {
        expect(checker.check("2:0")).toEqual(true)
        expect(checker.check("0.1:0")).toEqual(true)
      })
      test(`simple or(checkers) invalid`, () => {
        expect(checker.check("2.1:0")).toEqual(false)
        expect(checker.check("1:0")).toEqual(false)
        expect(checker.check("1.1:0")).toEqual(false)
      })
    }

    {
      ...
      test(`rangeOf(1.2.*) valid`, () => {
        expect(checker.check("1.2:0")).toEqual(true)
        expect(checker.check("1.2.1:0")).toEqual(true)
      })
      test(`rangeOf(1.2.*) invalid`, () => {
        expect(checker.check("1.3:0")).toEqual(false)
        expect(checker.check("1.3.1:0")).toEqual(false)

        expect(checker.check("1.1.1:0")).toEqual(false)
        expect(checker.check("1.1:0")).toEqual(false)
        expect(checker.check("1:0")).toEqual(false)
...

    {
      ...
      test(`notRange(rangeOf(1.2.*)) valid`, () => {
        expect(checker.check("1.3:0")).toEqual(true)
        expect(checker.check("1.3.1:0")).toEqual(true)

        expect(checker.check("1.1.1:0")).toEqual(true)
        expect(checker.check("1.1:0")).toEqual(true)
        expect(checker.check("1:0")).toEqual(true)
      ...
      test(`notRange(rangeOf(1.2.*)) invalid `, () => {
        expect(checker.check("1.2:0")).toEqual(false)
        expect(checker.check("1.2.1:0")).toEqual(false)
      })
    }
    {
      const checker = rangeOf("!1.2.*")
...

    {
      ...
      test("=1 || =2", () => {
        ...
        expect(checker.check("1:0")).toEqual(true)
        expect(checker.check("2:0")).toEqual(true)
        expect(checker.check("3:0")).toEqual(false)
      })
      ...
      test("&& before || order of operationns:  <1.5 && >1 || >1.5 && <3", () => {
        ...
        expect(checker.check("1.5:0")).toEqual(false)
        expect(checker.check("1:0")).toEqual(false)
        expect(checker.check("3:0")).toEqual(false)
      })

      test("Compare function on the emver", () => {
        const a = EmVer.from("1.2.3:0")
        const b = EmVer.from("1.2.4:0")
