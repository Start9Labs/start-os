% embassy-os(SECTION) | User Commands
%
% "September 19 2022"
...
embassy-os - program to do something

# SYNOPSIS

**embassy-os** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**embassy-os** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **embassy-os** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**embassy-os** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    embassy-os. See **foo.conf**(5) for further details.
...
**embassy-os** provides some return codes, that can be used in scripts:
...
Aiden <aiden@start9labs.com>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Aiden
