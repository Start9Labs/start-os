...
export const ENGLISH: Record<string, number> = {
  ...
  'Network UPS Tools': 909,
  'Configure': 910,
  'Direct UPS': 911,
  'Client': 912,
  'Monitoring a directly connected UPS': 886,
  'Monitoring a network UPS server': 887,
  'Shut down safely when a UPS battery is low': 888,
  'NUT shuts down StartOS when the UPS battery is low': 889,
  'Mode': 890,
  'UPS Name': 891,
  'Driver': 892,
  'Device or address': 893,
  'Monitor username': 894,
  'Monitor password': 895,
  'Allow network clients': 896,
  'Network client username': 897,
  'Network client password': 898,
  'Shutdown delay': 899,
  'Network UPS client': 900,
  'NUT server host': 901,
  'NUT server port': 902,
  'Configured target': 904,
  'No UPS data available': 905,
  'UPS status unavailable': 906,
  'StartOS could not read UPS status with the current NUT configuration.': 907,
  'The UPS did not return status data. Check the UPS name, host, port, credentials, and driver.': 908,
}
