...
.angular/.updated: vendor/patch-db/client/dist/index.js projects/start-sdk/baseDist/package.json node_modules/.package-lock.json
	rm -rf .angular
	mkdir -p .angular
